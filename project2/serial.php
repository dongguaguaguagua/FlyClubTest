...
if($_GET['act'] == 'insert'){
    ...
    $sql = "insert into serial (name,serialName,link,extractCode,notes) values ('".$_POST['name']."','".$_POST['serialName']."','".$_POST['link']."','".$_POST['extractCode']."','".$_POST['notes']."')";
...
elseif($_GET['act'] == 'delete'){
    $select_deleted_sql = "select * from serial where serialName ='".$_GET['serialName']."' LIMIT 1";
    $deleted_sql = mysqli_query($connect_mysql,$select_deleted_sql);
    $row = mysqli_fetch_array($deleted_sql);
    $insert_deleted_sql = "insert into deleted (name,mediaName,link,extractCode,notes) values ('".$row['name']."','".$row['serialName']."','".$row['link']."','".$row['extractCode']."','".$row['notes']."')";
    $sql = "delete from serial where serialName = '".$_GET['serialName']."' LIMIT 1";
