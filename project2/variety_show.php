...
if($_GET['act'] == 'insert'){
    ...
    $sql = "insert into variety_show (name,showName,link,extractCode,notes) values ('".$_POST['name']."','".$_POST['showName']."','".$_POST['link']."','".$_POST['extractCode']."','".$_POST['notes']."')";
...
elseif($_GET['act'] == 'delete'){
    $select_deleted_sql = "select * from variety_show where showName ='".$_GET['showName']."' LIMIT 1";
    $deleted_sql = mysqli_query($connect_mysql,$select_deleted_sql);
    $row = mysqli_fetch_array($deleted_sql);
    $insert_deleted_sql = "insert into deleted (name,mediaName,link,extractCode,notes) values ('".$row['name']."','".$row['showName']."','".$row['link']."','".$row['extractCode']."','".$row['notes']."')";
    $sql = "delete from variety_show where showName = '".$_GET['showName']."' LIMIT 1";
...
$select_sql = " select * from variety_show ";
